...
import { useDemoData, useDemoPopup } from '../context/DemoContext';
import { demoDb } from '../demo/lib/demoDb';
...
export const Accounts = ({ view = 'accounts', onViewChange }) => {
  const data = useDemoData();
  const triggerDemoPopup = useDemoPopup();
  const props = { ...data, onViewChange, triggerDemoPopup, getJournalLines: demoDb.getJournalLines, mode: 'demo' };
