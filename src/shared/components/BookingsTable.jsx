...
export const BookingsTable = ({ bookings, customers = [], onAction }) => {
  ...
  const handleAction = (e, actionType, bookingId) => {
    e.stopPropagation();
    setActiveDropdownId(null);
    if (onAction) onAction(actionType, bookingId);
  };
                    ...
                    <div className="status-dropdown-wrapper">
                      ...
                      {activeDropdownId === b.id && b.status === 'confirmed' && (
                        <div className="status-dropdown">
                          <div className="status-drop-item status-drop-approve" onClick={(e) => handleAction(e, 'complete', b.id)}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                            Mark Completed
                          </div>
                          <div className="status-drop-item status-drop-reject" onClick={(e) => handleAction(e, 'cancel', b.id)}>
                      ...
                      {activeDropdownId === b.id && b.status === 'completed' && (
                        <div className="status-dropdown">
                          <div className="status-drop-item status-drop-reopen" onClick={(e) => handleAction(e, 'reopen', b.id)}>
