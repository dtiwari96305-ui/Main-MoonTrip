...
import { lettersOnly, phoneOnly } from '../../utils/inputHelpers';
          ...
          <form id="add-vendor-form" onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <div className="rp-row-2">
              ...
              <div className="rp-field">
                ...
                <input className="rp-input" value={form.contactPerson} onChange={e => set('contactPerson', lettersOnly(e.target.value))} placeholder="Name" />
              </div>
            </div>
            ...
            <div className="rp-row-2">
              <div className="rp-field">
                ...
                <input className="rp-input" value={form.phone} onChange={e => set('phone', phoneOnly(e.target.value))} placeholder="+91 98800 00000" />
              </div>
              <div className="rp-field">
                <label className="rp-field-label">
