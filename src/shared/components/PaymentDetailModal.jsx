...
// ─── Main Component ────────────────────────────────────────────────────────────
export const PaymentDetailModal = ({ paymentId, onClose, getPaymentById, onSave }) => {
  const [isVisible, setIsVisible] = useState(false);
  const [isEditMode, setIsEditMode] = useState(false);

  const payment = getPaymentById ? getPaymentById(paymentId) : null;
        ...
        {!isEditMode ? (
          ...
          <div className="pdm-default-view">
            ...
            <div className="pdm-actions">
              ...
              <button className="pdm-action-btn pdm-btn-edit" onClick={() => onSave && onSave('edit', paymentId)}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" />
                </svg>
                Edit
              </button>
              <button className="pdm-action-btn pdm-btn-share" onClick={() => onSave && onSave('share', paymentId)}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="pdm-edit-view">
            ...
            <div className="pdm-edit-footer">
              ...
              <button className="pdm-save-btn" onClick={() => onSave && onSave('save', paymentId, { amount: editAmount, mode: editMode, date: editDate, ref: editRef, bank: editBank, notes: editNotes })}>
