...
export function drawIndiaMap(canvas) {
  ...
  // Goa
  ctx.beginPath(); ctx.arc(cx - sw*0.22, cy + sh*0.2, 5, 0, Math.PI*2); ctx.fillStyle='#16A34A'; ctx.fill(); ctx.strokeStyle='#fff'; ctx.lineWidth=2; ctx.stroke();
  // Srinagar
  ctx.beginPath(); ctx.arc(cx - sw*0.05, cy - sh*0.4, 5, 0, Math.PI*2); ctx.fillStyle='#16A34A'; ctx.fill(); ctx.strokeStyle='#fff'; ctx.lineWidth=2; ctx.stroke();
}
...
export function drawWorldMap(canvas) {
  ...
  ctx.beginPath(); ctx.arc(W*0.73,H*0.58,5,0,Math.PI*2); ctx.fillStyle='#16A34A'; ctx.fill(); ctx.strokeStyle='#fff'; ctx.lineWidth=2; ctx.stroke();
}
