...
export const RealAccounts = () => {
  ...
  return (
    <div id="view-accounts" className="fade-in">
      ...
      {/* ── Header ── */}
      <Header title="Accounts" subtitle="Hidden Markup Memorandum" showNewQuote={false}>
        {/* Convert to Invoice */}
        ...
        <button className="acct-adjust-btn" onClick={() => {}}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <line x1="12" y1="5" x2="12" y2="19"/>
            <polyline points="19 12 12 19 5 12"/>
            <line x1="5" y1="5" x2="19" y2="5"/>
        ...
        <ExportDropdown
          data={[]}
          columns={activeTab === 'markup' ? MARKUP_COLUMNS : activeTab === 'invoices' ? INVOICES_COLUMNS : ADJUSTMENTS_COLUMNS}
        ...
        <div className="cti-overlay">
          <div className="cti-modal">
            ...
            <div className="cti-actions">
              ...
              <button className="cti-create-btn" onClick={() => setShowConvertModal(false)}>Create Invoice</button>
            </div>
          </div>
        </div>,
        document.body
